 ...
 namespace FinalVirtualBot.Server.Controllers
{
        ...
        public class UserAuthenticationController : ControllerBase
        {
            ...
            public UserAuthenticationController(UserManager<ApplicationUser> userManager, RoleManager<ApplicationRole> roleManager)
            {
                    ...
                    var claims = new List<Claim>
            {
                ...
                new Claim(ClaimTypes.NameIdentifier, user.Id.ToString())
                    ...
                    var key = new SymmetricSecurityKey(Encoding.UTF8.GetBytes("thisis the secret key hello hello1234567890@!@!@ the secret key the best of all"));
